...
(function (ga) {
    ...
    function ma(b) {
        ...
        da.prototype = {
            ...
            defineDep: function (a, b) {
                this.depMatched[a] || (this.depMatched[a] = !0, --this.depCount, this.depExports[a] =
                    b)
            },
            fetch: function () {
                if (!this.fetched) {
                        ...
                        if (1 > this.depCount && !this.defined) {
                            if (K(k)) {
                                if (this.events.error && this.map.isDefine || g.onError !== ha)
                                    ...
                                    h = l.execCb(c, k, b, h);
                                this.map.isDefine &&
                                void 0 === h && (( b = this.module) ? h = b.exports : this.usingExports && ( h = this.exports));
                                if (a)
            ...
            completeLoad: function (a) {
                ...
                if (!b && !x(v, a) && c && !c.inited)
                    if (!p.enforceDefine || g && ia(g))
                        ...
                        return m(a) ?
                            void 0 : A(F("nodefine", "No define call for " + a, null, [a]));
                H()
            },
    ...
    if ("undefined" === typeof define) {
        ...
        g = requirejs = function (b, c, d, m) {
            var r,
                q = "_";
            L(b) || "string" === typeof b || ( r = b, L(c) ? ( b = c,
                c =
                    d,
                d =
                    m) : b = []);
        ...
        E && !w.skipDataMain && X(document.getElementsByTagName("script"), function (b) {
            ...
            if (O = b.getAttribute("data-main"))
                return u = O, w.baseUrl || -1 !== u.indexOf("!") || ( I = u.split("/"),
                    u = I.pop(),
                    T = I.length ? I.join("/") + "/" : "./", w.baseUrl =
                    T),
                    u = u.replace(U, ""), g.jsExtRegExp.test(u) && ( u = O), w.deps = w.deps ? w.deps.concat(u) : [u], !0
        });
